...
class bag3_testbenches__clock_buf_tb(Module):
    """Module for library bag3_testbenches cell clock_buf_tb.
    ...
    def get_params_info(cls) -> Dict[str, str]:
        ...
        return dict(
            ...
            remove_cap_list='List of capacitors to be removed',
        )
    ...
    def design(self, dut_lib: str, dut_cell: str, dut_conns: Optional[Dict[str, str]],
        ...
        for cap in remove_cap_list:
            self.remove_instance(cap)
