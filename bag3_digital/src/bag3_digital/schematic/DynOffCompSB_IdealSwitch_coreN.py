...
class bag3_digital__DynOffCompSB_IdealSwitch_coreN(Module):
    """Module for library bag3_digital cell DynOffCompSB_IdealSwitch_coreN.
    ...
    yaml_file = pkg_resources.resource_filename(__name__,
                                                str(Path('netlist_info',
                                                         'DynOffCompSB_IdealSwitch_coreN.yaml')))
