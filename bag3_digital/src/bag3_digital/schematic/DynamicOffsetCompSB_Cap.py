...
class bag3_digital__DynamicOffsetCompSB_Cap(Module):
    """Module for library bag3_digital cell DynamicOffsetCompSB_Cap.
    ...
    def design(self, cap_cross_params: Dict[str, Any], doc_params: Dict[str, Any],
               ideal_switch: bool, mode: int) -> None:
        ...
        if ideal_switch:
            self.replace_instance_master('XDOC', 'bag3_digital',
                                         'DynamicOffsetCompSB_IdealSwitch_core',
