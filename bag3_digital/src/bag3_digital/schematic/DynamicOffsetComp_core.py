...
class bag3_digital__DynamicOffsetComp_core(Module):
    """Module for library bag3_digital cell DynamicOffsetComp_core.
    ...
    def design(self, seg_dict: Dict[str, int], lch: int, w_dict: Dict[str, int],
        ...
        for _name, _str in zip(['XM1', 'XM2', 'XS5', 'XS1', 'XS2', 'XS3', 'XS4'],
                               ['gm2n', 'gm2n', 'sw5', 'sw12', 'sw12', 'sw34', 'sw34']):
