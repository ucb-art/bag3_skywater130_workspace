...
class bag3_digital__DynOffCompVb_core2N(Module):
    """Module for library bag3_digital cell DynOffCompVb_core2N.
    ...
    def design(self, seg_dict: Dict[str, int], lch: int, w_dict: Dict[str, int],
               th_dict: Dict[str, str], dum_info: List[Tuple[Any]], ideal_switch: bool) -> None:
        ...
        """
        # nch devices
        for _name, _str in zip(['XM1', 'XM2', 'XMc1', 'XMc2'],
                               ['gm2n', 'gm2n', 'gm1', 'gm1']):
        ...
        # enable switches
        for _name, _str in zip(['XEN1', 'XEN2'], ['en12', 'en12']):
            self.design_transistor(_name, w_dict[_str], lch, seg_dict[_str], th_dict[_str])
