...
class bag3_digital__DynamicOffsetCompSB_IdealSwitch_core(Module):
    """Module for library bag3_digital cell DynamicOffsetCompSB_IdealSwitch_core.
    ...
    yaml_file = pkg_resources.resource_filename(__name__,
                                                str(Path('netlist_info',
                                                         'DynamicOffsetCompSB_IdealSwitch_core.yaml')))
    ...
    def design(self, seg_dict: Dict[str, int], lch: int, w_dict: Dict[str, int],
        ...
        for _name, _str in zip(['XM1', 'XM2'], ['gm2n', 'gm2n']):
