...
from bag3_digital.layout.resdac.decoder import InvBuffer as lay_gen
from xbase.layout.mos.top import GenericWrapper
from bag.design.database import ModuleDB
from bag3_digital.schematic.inv_buffer import bag3_digital__inv_buffer as sch_gen


def run_main(prj: BagProject, gen_sch: bool = False, run_lvs: bool = False) -> None:
    lib_name = 'AAA_INV_BUFF'
    fname = 'unit_tests_resdac/inv_buffer.yaml'
