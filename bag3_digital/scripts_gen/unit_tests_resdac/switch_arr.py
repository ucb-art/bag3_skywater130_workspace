...
from bag3_digital.layout.resdac.switch_arr import SwitchArray as lay_gen
from xbase.layout.mos.top import GenericWrapper
from bag.design.database import ModuleDB
from bag3_digital.schematic.switch_arr import bag3_digital__switch_arr as sch_gen


def run_main(prj: BagProject, gen_sch: bool = False, run_lvs: bool = False) -> None:
    lib_name = 'AAA_Switch'
    fname = 'unit_tests_resdac/switch_arr.yaml'

    impl_cell = 'switch_arr'
