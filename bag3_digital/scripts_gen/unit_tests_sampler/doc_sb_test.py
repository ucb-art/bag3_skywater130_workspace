...
from bag3_digital.layout.sampler.DynamicOffsetCompSB import DynamicOffsetCompSB_Wrapper
from bag3_digital.schematic.DynamicOffsetCompSB_Cap import bag3_digital__DynamicOffsetCompSB_Cap


def run_main(prj: BagProject, gen_sch: bool = False, gen_cdl: bool = False, run_lvs: bool = False,
             run_rcx: bool = False) -> None:
    lib_name = 'AAA_BAG3_DynamicOffsetCompSB'
    fname = 'doc_sb.yaml'

    impl_cell = 'DynamicOffsetCompSB_top'
    ...
    master = db.new_template(DynamicOffsetCompSB_Wrapper, params)
    ...
    if gen_sch or gen_cdl:
        ...
        sch_master = sch_db.new_master(bag3_digital__DynamicOffsetCompSB_Cap, master.sch_params)
        cv_info_list = []
