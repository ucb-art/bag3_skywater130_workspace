...
from bag3_digital.layout.sampler.comparator_top import ComparatorTop as lay_cell
from bag3_digital.schematic.comparator_top import bag3_digital__comparator_top as sch_cell


def run_main(prj: BagProject, gen_sch: bool = False, gen_cdl: bool = False, run_lvs: bool = False,
             run_rcx: bool = False) -> None:
    lib_name = 'AAA_BAG3_ComparatorTop3'
    fname = 'comparator_top.yaml'

    impl_cell = 'ComparatorTop'
    ...
    master = db.new_template(lay_cell, params)
    ...
    if gen_sch or gen_cdl:
        ...
        sch_master = sch_db.new_master(sch_cell, master.sch_params)
        cv_info_list = []
