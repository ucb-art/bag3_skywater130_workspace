...
from bag3_digital.layout.sampler.comparator_top import CompOutTop_Wrapper
from bag3_digital.schematic.comp_out_top import bag3_digital__comp_out_top


def run_main(prj: BagProject, gen_sch: bool = False, gen_cdl: bool = False, run_lvs: bool = False,
             run_rcx: bool = False) -> None:
    lib_name = 'AAA_BAG3_CompOutTop'
    fname = 'comp_out_top.yaml'

    impl_cell = 'CompOutTop'
    ...
    master = db.new_template(CompOutTop_Wrapper, params)
    ...
    if gen_sch or gen_cdl:
        ...
        sch_master = sch_db.new_master(bag3_digital__comp_out_top, master.sch_params)
        cv_info_list = []
