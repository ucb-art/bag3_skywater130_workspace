...
from bag3_digital.layout.sampler.complex_logic_gates import ResetRow
from bag3_digital.schematic.reset_row import bag3_digital__reset_row


def run_main(prj: BagProject, gen_sch: bool = False, gen_cdl: bool = False, run_lvs: bool = False,
             run_rcx: bool = False) -> None:
    lib_name = 'AAA_BAG3_ResetRow'
    fname = 'reset_row.yaml'
    ...
    master = db.new_template(ResetRow, params)
    ...
    if gen_sch or gen_cdl:
        ...
        sch_master = sch_db.new_master(bag3_digital__reset_row, master.sch_params)
        cv_info_list = []
