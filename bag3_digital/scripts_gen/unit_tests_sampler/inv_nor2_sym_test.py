...
from bag3_digital.layout.sampler.complex_logic_gates import InvNOR2Sym
from bag3_digital.schematic.inv_nor2_sym import bag3_digital__inv_nor2_sym

from bag3_digital.layout.resdac.gates import STDCellWithTap
...
def run_main(prj: BagProject, gen_sch: bool = False, gen_cdl: bool = False, run_lvs: bool = False,
    ...
    lib_name = 'AAA_BAG3_InvNOR2Sym'
    fname = 'inv_nor2_sym.yaml'

    impl_cell = 'InvNOR2Sym'
    ...
    wrap_params = dict(
        cls_name=STDCellWithTap.get_qualified_name(),
        params=params,
    )
    ...
    # master = db.new_template(InvNOR2Sym, params)
    ...
    if gen_sch or gen_cdl:
        ...
        sch_master = sch_db.new_master(bag3_digital__inv_nor2_sym, master.sch_params)
        cv_info_list = []
