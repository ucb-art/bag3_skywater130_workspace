...
from bag3_digital.design.flop_strongarm import FlopStrongArmDesigner
...
def parse_options() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description='BAG3_analog rstb_strongarm_flop design script.')
...
def run_main(prj: BagProject, args: argparse.Namespace) -> None:
    ...
    designer = FlopStrongArmDesigner(prj, spec_dict=specs)
